...
public class DataAdapterFavorite extends RecyclerView.Adapter<DataAdapterFavorite.DatakuViewHolder>{
    ...
    private List<RealmItemModel> dataList;
    ...
    public DataAdapterFavorite(List<RealmItemModel> dataList, Callback callback) {
    ...
    public void onBindViewHolder(final DatakuViewHolder holder, final int position) {
        ...
        holder.txtNpm.setText("Formed At "+dataList.get(position).getFormed_year()+ ", From " + dataList.get(position).getTeam_country());
        //pakai glide karena untuk nampilkan data gambar dari URL / permission / graddle
        Glide.with(holder.itemView)
                .load(dataList.get(position).getTeam_badge_URL())
    ...
    public class DatakuViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener{
        ...
        public DatakuViewHolder(View itemView) {
            ...
            ivprofile = (ImageView) itemView.findViewById(R.id.img_ImageIcon);
            txtNama = (TextView) itemView.findViewById(R.id.tv_listTitle);
            txtNpm = (TextView) itemView.findViewById(R.id.tv_listDescriptionAdapter);
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case 2:
                    ...
                    builder.setMessage("Are you sure To Remove This From Your Favorite Teams?").setPositiveButton("Yes", dialogClickListener)
